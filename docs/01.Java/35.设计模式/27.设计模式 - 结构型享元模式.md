...
![image-20220314190648003](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213417.png)
...
![image-20220314190636066](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213419.png)
...
![image-20220314190248901](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213422.png)
...
![image-20220314190856461](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213425.png)
...
![image-20220314191251956](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/design-pattern/20220316213452.png)
...
享元模式其实是 [工厂方法模式](/design-pattern/factory/#工厂方法-factory-method) 的一个改进机制，享元模式同样要求创建一个或一组对象，并且就是通过工厂方法模式生成对象的，只不过享元模式为工厂方法模式增加了缓存这一功能。
